...
//    private static final Log LOG = LogFactory.getLog(Handler.class);
    ...
    static {
        AbstractRegisteringURLStreamHandler.registerHandler(Handler.class);
    }
...
//            mergedJCacheXmlBytes = IOUtils.toByteArray(inputStream);
              mergedJCacheXmlBytes = new byte[inputStream.available()];
              inputStream.read(mergedJCacheXmlBytes);
//              inputStream.close();
/*
